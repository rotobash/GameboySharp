...
namespace Gameboy.Opcodes.ExtendedOpcodes
{
    public class EightInstructions : Opcode
    {
        ...
        {
            BitOperations.RESETBIT(cpu, 0, cpu.BC, true);
            return 4;
        }
        public override int OneSuffix() 
        {
            BitOperations.RESETBIT(cpu, 0, cpu.BC, false);
            return 4;
        }
        public override int TwoSuffix() 
        {
            BitOperations.RESETBIT(cpu, 0, cpu.DE, true);
            return 4;
        }
        public override int ThreeSuffix() 
        {
            BitOperations.RESETBIT(cpu, 0, cpu.DE, false);
            return 4;
        }
        public override int FourSuffix() 
        {
            BitOperations.RESETBIT(cpu, 0, cpu.HL, true);
            return 4;
        }
        public override int FiveSuffix() 
        {
            BitOperations.RESETBIT(cpu, 0, cpu.HL, false);
            return 4;
        }
        ...
        {
            BitOperations.RESETBIT(cpu, 0, cpu.AF, true);
            return 4;
        }
        public override int EightSuffix() 
        {
            BitOperations.RESETBIT(cpu, 1, cpu.BC, true);
            return 4;
        }
        public override int NineSuffix() 
        {
            BitOperations.RESETBIT(cpu, 1, cpu.BC, false);
            return 4;
        }
        public override int ASuffix() 
        {
            BitOperations.RESETBIT(cpu, 1, cpu.DE, true);
            return 4;
        }
        public override int BSuffix() 
        {
            BitOperations.RESETBIT(cpu, 1, cpu.DE, false);
            return 4;
        }
        public override int CSuffix() 
        {
            BitOperations.RESETBIT(cpu, 1, cpu.HL, true);
            return 4;
        }
        public override int DSuffix() 
        {
            BitOperations.RESETBIT(cpu, 1, cpu.HL, false);
            return 4;
        }
        ...
        {
            BitOperations.RESETBIT(cpu, 1, cpu.AF, true);
            return 4;
        }
    }
}
