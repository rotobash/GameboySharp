...
namespace Gameboy.Opcodes.ExtendedOpcodes
{
    public class CInstructions : Opcode
    {
        ...
        {
            BitOperations.SETBIT(cpu, 0, ref cpu.BC, true);
            return 4;
        }
        public override int OneSuffix() 
        {
            BitOperations.SETBIT(cpu, 0, ref cpu.BC, false);
            return 4;
        }
        public override int TwoSuffix() 
        {
            BitOperations.SETBIT(cpu, 0, ref cpu.DE, true);
            return 4;
        }
        public override int ThreeSuffix() 
        {
            BitOperations.SETBIT(cpu, 0, ref cpu.DE, false);
            return 4;
        }
        public override int FourSuffix() 
        {
            BitOperations.SETBIT(cpu, 0, ref cpu.HL, true);
            return 4;
        }
        public override int FiveSuffix() 
        {
            BitOperations.SETBIT(cpu, 0, ref cpu.HL, false);
            return 4;
        }
        ...
        {
            BitOperations.SETBIT(cpu, 0, ref cpu.AF, true);
            return 4;
        }
        public override int EightSuffix() 
        {
            BitOperations.SETBIT(cpu, 1, ref cpu.BC, true);
            return 4;
        }
        public override int NineSuffix() 
        {
            BitOperations.SETBIT(cpu, 1, ref cpu.BC, false);
            return 4;
        }
        public override int ASuffix() 
        {
            BitOperations.SETBIT(cpu, 1, ref cpu.DE, true);
            return 4;
        }
        public override int BSuffix() 
        {
            BitOperations.SETBIT(cpu, 1, ref cpu.DE, false);
            return 4;
        }
        public override int CSuffix() 
        {
            BitOperations.SETBIT(cpu, 1, ref cpu.HL, true);
            return 4;
        }
        public override int DSuffix() 
        {
            BitOperations.SETBIT(cpu, 1, ref cpu.HL, false);
            return 4;
        }
        ...
        {
            BitOperations.SETBIT(cpu, 1, ref cpu.AF, true);
            return 4;
        }
    }
}
